...
export default function DashboardPage() {
  ...
  const statCards = overview
    ? [
        ...
        {
          label: "Vendas do mês",
          value: formatCurrency(overview.monthlySales),
          icon: TrendingUp,
        ...
        },
        {
          ...
          value: overview.todayAppointments.toString(),
          icon: Calendar,
          color: "text-purple-600 bg-purple-50",
        },
        {
          label: "A receber (aberto)",
          value: formatCurrency(overview.openReceivables),
          icon: Eye,
  ...
  return (
    <AppShell>
      <PageHeader
        title="Painel"
        description={`Visão geral em tempo real — ${storageLabel}`}
      />
